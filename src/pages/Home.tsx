    ...
    <div className="min-h-screen relative overflow-hidden bg-gradient-to-br from-slate-950 via-blue-950 to-slate-950">
      ...
      <section className="pt-32 pb-32 px-4 md:px-8 relative">
        <div className="mx-auto text-center max-w-7xl">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-7xl lg:text-8xl font-bold mb-6 md:mb-8 bg-gradient-to-r from-blue-400 via-cyan-400 to-purple-400 bg-clip-text text-transparent leading-tight px-4 animate-fade-in">
            The Future of<br />Freelancing is Here
          </h1>
          
          <p className="text-sm sm:text-base md:text-2xl text-gray-300 mb-8 md:mb-12 max-w-4xl mx-auto leading-relaxed px-4">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 max-w-6xl mx-auto">
            {stats.map((stat, index) => (
              <Card key={index} className="p-4 sm:p-6 md:p-8 bg-white/5 backdrop-blur-sm border-blue-500/20 shadow-lg hover:shadow-blue-500/30 transition-all duration-300 hover:scale-105 group">
                <stat.icon className="w-6 h-6 sm:w-8 sm:h-8 md:w-10 md:h-10 text-blue-400 mx-auto mb-2 sm:mb-3 group-hover:scale-110 transition-transform" />
                <div className="text-xl sm:text-3xl md:text-4xl font-bold mb-1 sm:mb-2 bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">
                  {stat.value}
                </div>
      ...
      <section id="how-it-works" className="py-24 px-4 md:px-8 relative">
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-16 md:mb-20">
            <h2 className="text-2xl sm:text-3xl md:text-6xl font-bold mb-4 md:mb-6 bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">
              How It Works
            </h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
            {howItWorks.map((item, index) => (
              <div key={index} className="relative">
                <Card className="p-6 sm:p-8 bg-white/5 backdrop-blur-sm border-blue-500/20 shadow-lg hover:shadow-blue-500/30 transition-all duration-300 h-full group hover:scale-105">
                  <div className="w-12 h-12 sm:w-16 sm:h-16 rounded-full bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center mb-4 sm:mb-6 text-xl sm:text-2xl font-bold text-white shadow-lg shadow-blue-500/50 group-hover:scale-110 transition-transform">
                    {item.step}
                  </div>
                  <h3 className="text-base sm:text-xl md:text-2xl font-bold mb-3 sm:mb-4 text-white group-hover:text-blue-400 transition-colors">
                    {item.title}
                  </h3>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            {features.map((feature, index) => {
              ...
              return (
                <Card 
                  key={index} 
                  className="p-6 sm:p-8 md:p-10 bg-white/5 backdrop-blur-sm border-blue-500/20 shadow-lg hover:shadow-blue-500/30 transition-all duration-300 hover:scale-105 group"
                >
                  <div className={`w-12 h-12 sm:w-16 sm:h-16 md:w-20 md:h-20 rounded-2xl ${feature.gradient} flex items-center justify-center mb-4 sm:mb-6 group-hover:scale-110 transition-transform shadow-lg`}>
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
            {categories.map((category, index) => (
              <Card 
                key={index}
                className="p-6 sm:p-8 bg-white/5 backdrop-blur-sm border-blue-500/20 shadow-lg hover:shadow-blue-500/30 transition-all duration-300 hover:scale-105 group cursor-pointer text-center"
              >
                <category.icon className="w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 text-blue-400 mx-auto mb-3 sm:mb-4 group-hover:scale-110 transition-transform" />
                <h3 className="text-base sm:text-lg md:text-xl font-bold mb-1 sm:mb-2 text-white group-hover:text-blue-400 transition-colors">
                  {category.name}
                </h3>
                <p className="text-xs sm:text-sm text-gray-400">{category.count} jobs</p>
              </Card>
            ))}
          </div>
        </div>
      ...
      <section className="py-24 px-4 md:px-8 relative">
        <div className="mx-auto max-w-7xl">
          <Card className="p-6 sm:p-10 md:p-16 bg-white/5 backdrop-blur-sm border-blue-500/20 shadow-lg shadow-blue-500/20">
            <div className="grid md:grid-cols-2 gap-8 sm:gap-12 items-center">
              <div>
                <Lock className="w-10 h-10 sm:w-12 sm:h-12 text-blue-400 mb-4 sm:mb-6" />
                <h2 className="text-2xl sm:text-3xl md:text-5xl font-bold mb-4 sm:mb-6 bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">
                ...
                <div className="space-y-3 sm:space-y-4">
                  {benefits.map((benefit, index) => (
                    <div key={index} className="flex items-start gap-2 sm:gap-3">
                      <CheckCircle className="w-5 h-5 sm:w-6 sm:h-6 text-blue-400 flex-shrink-0 mt-0.5" />
