  ...
  const handleApproveWork = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: "Releasing funds via backend...",
      });

      // Call backend edge function to release payment via arbitrator
      ...
      console.log('Payment released via arbitrator:', data.txHash);
